...
class CocoConfig(Config):
    """Configuration for training on Kaggle Bowl 2018 dataset.
    Derives from the base Config class and overrides values specific
    to the Kaggle Bowl 2018 dataset.
    """
    # Give the configuration a recognizable name
    NAME = "kaggle_bowl_2018"
    ...
    NUM_CLASSES = 2  # nuclei has one class and one background
