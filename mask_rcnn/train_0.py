...
def train_augment(image, multi_mask, meta, index):
    image, multi_mask = random_shift_scale_rotate_transform2(image, multi_mask,
                                                             ...
                                                             rotate_limit=[-45, 45], borderMode=cv2.BORDER_REFLECT_101,
        ...
        for inputs, truth_boxes, truth_labels, truth_instances, metas, indices in train_loader:
            ...
            if 1:
                ...
                for b in range(batch_size):
                    ...
                    all5 = draw_multi_proposal_metric(cfg, image, rpn_proposal, truth_box, truth_label, [0, 255, 255],
                                                      [255, 0, 255], [255, 255, 0])
                    all6 = draw_multi_proposal_metric(cfg, image, rcnn_proposal, truth_box, truth_label, [0, 255, 255],
                                                      [255, 0, 255], [255, 255, 0])
