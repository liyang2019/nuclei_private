...
def compute_hit_fp_for_box(proposals, truth_boxes, truth_labels):
    ...
    for (proposal, truth_box, truth_label) in zip(proposals, truth_boxes, truth_labels):
        box = proposal[:, 1:5]
        precision, recall, result, truth_result = compute_precision_for_box(box, truth_box, truth_label,
                                                                            threshold=[0.5])
...
#
#     for precision, recall, result, truth_result, threshold in zip(precisions, recalls, results, truth_results,
#                                                                   thresholds):
#         print('')
