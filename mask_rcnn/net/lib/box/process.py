...
from mask_rcnn.net.lib.box.overlap.cython_overlap.cython_box_overlap import cython_box_overlap
from mask_rcnn.net.lib.box.nms.torch_nms import torch_nms
# from net.lib.box.nms.gpu_nms import gpu_nms
from mask_rcnn.net.lib.box.nms.cython_nms.cython_nms import cython_nms
from mask_rcnn.net.lib.box.nms.py_nms import py_nms
...
def torch_box_overlap(boxes, gt_boxes):
    ...
    gt_boxes: (K, 4) ndarray or tensor or variable
    Returns
    -------
