...
if 1:
    ...
    # os.system(('scp -i ~/.ssh/mykey.pem -r ubuntu@ec2-34-217-126-197.us-west-2.compute.amazonaws.com:/home/ubuntu/nuclei_private/saved_models/2018-4-15_models_gray800_00026500_model.pth/2018-04-15_20-41-17_ensemble_00026500_model/none/submit/overlays ./'))
    os.system('scp -i ~/.ssh/mykey.pem -r ubuntu@ec2-34-217-126-197.us-west-2.compute.amazonaws.com:/home/ubuntu/nuclei_private/saved_models/2018-4-15_models_gray800_00026500_model_on_blue ./')
    print('success')
